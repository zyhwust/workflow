<template>
    <li>
	    <div>
	      ...
	      <!-- <span @click="checkByDep(b,user)">全选</span> -->
	      <!-- <input v-if="allChecked" @click="checkByDep(b,user)" type="checkbox" checked> -->
	      ...
	      <!-- <input v-else type="checkbox" @click="checkByDep(b,user)"> -->
	    </div>
	    ...
	    <ul v-show="open" v-if="isFolder" >
	      	...
	      	<!-- <li v-if="users.length>0" @click="checkByDep(b,user)" class="user">
	    		<div class="img_wrap">
	    			<div v-if="allChecked"  class="icon">
                      	<i class="fa fa-check checked1"  aria-hidden= "true"></i>
                    </div>
                    <div v-else class="icon">
                      	<i class="fa fa-users checked1"  aria-hidden= "true"></i>
                    </div>
	    		</div>
	    		全选
	    	</li> -->
	...
	export default{
		...
		computed: {
		  ...
		  //   	var obj1025 = {
		    ...
		    haveUser: function () {
		      return this.model.usersInfo&&this.model.usersNum.length
		    }
		},
		watch:{
			'users': {
